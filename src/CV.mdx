...
between 2014 and 2022. Transitioned to a sub-lead within the Item-Stock team
formed during the migration to microservice architecture. Later, led the SPKit
Framework team, responsible for defining development standards, creating tools
and frameworks to accelerate development and uphold code quality.
...
new team for building a completely new system that covers all current features
and allows spawning new sites faster.
