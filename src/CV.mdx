...
utilizing the vast Azure ecosystem. Work mostly on the control plane (support
allocating and billing Azure resources for customers):
...
Took a rest, be with my family, lost some weight and recharged my energy.
